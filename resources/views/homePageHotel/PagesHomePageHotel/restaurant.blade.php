      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="{{url('/index')}}">Home</a></span> <span>Restaurants</span></p>
		...
		<section class="ftco-section ftc-no-pb ftc-no-pt">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 img-3 d-flex justify-content-center align-items-center" style="background-image: url({{URL::asset('designHomePageHotel/images/about.jpg')}});">
					</div>
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-1.jpg')}});"></div>
        			<div class="desc pl-3">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-2.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Grilled Beef with potatoes</span></h3>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-3.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Grilled Beef with potatoes</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-4.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Grilled Beef with potatoes</span></h3>
	        				<span class="price">$20.00</span>
        	...
        	<div class="col-md-6">
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-5.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Grilled Beef with potatoes</span></h3>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-6.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-7.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
	        				<h3><span>Grilled Beef with potatoes</span></h3>
	        				<span class="price">$20.00</span>
        		...
        		<div class="pricing-entry d-flex ftco-animate">
        			<div class="img" style="background-image: url({{URL::asset('designHomePageHotel/images/menu-8.jpg')}});"></div>
        			<div class="desc pl-3">
	        			<div class="d-flex text align-items-center">
